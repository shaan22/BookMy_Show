...
function Premeier(){
    return (
        <div id="grp__Cards2"> 
        <div class="hero_text">
        <img src="https://in.bmscdn.com/discovery-catalog/collections/tr:w-1440,h-120/premiere-rupay-banner-web-collection-202104230555.png" alt="" width="100%" height="100%"/>
        </div>
    ...
    <Card.Footer>
      <small className="text-muted" style={{fontSize:"15px"}}>Action/Horror/Sci-Fi/Thriller</small>
    </Card.Footer>
  </Card>
  <Card id="crd_1">
  <Card.Img variant="top" style={{borderRadius:"10px",height:"24.8rem"}} src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:oi-discovery-catalog@@icons@@heart_202006300400.png,ox-24,oy-617,ow-29:ote-NzglICA3Njcgdm90ZXM%3D,ots-29,otc-FFFFFF,oy-612,ox-70:q-80/et00322589-ncjqlsnzyj-portrait.jpg" />
    ...
    <Card.Footer>
      <small className="text-muted" style={{fontSize:"15px"}}>Crime Thiller</small>
    </Card.Footer>
  </Card>
  <Card id="crd_1">
