...
import {Form,Col,  Button, FormGroup, FormControl, ControlLabel, Container } from "react-bootstrap";
  ...
  async function UserPost() {
    ...
    const userDetails = {
      ...
      password: passwordd,
        ...
        await axios.post("http://localhost:3000/register/user-register", userDetails)
      .then((data) => {
        Swal.fire({
